<nav class="navbar px-8 sm:px-12 lg:px-24 py-4 flex flex-row justify-between z-50 fixed top-0 w-full transition duration-300">
    ...
    <div
        ...
        <a href="/"
            class="px-2.5 py-1.5 font-semibold rounded-lg text-base xl:text-lg hover:text-slate-400 group-[.scrolled]:hover:text-blue-800 {{ request()->is('/') ? 'textBlue' : 'textSlate' }}">Beranda</a>
        <a href="/fungsionaris"
