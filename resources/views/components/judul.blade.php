        ...
        <div
            ...
            <div class="flex flex-col p-4 leading-normal">
                <h5 class=" mt-6 mb-2 text-2xl text-center font-bold tracking-tight text-gray-900 dark:text-white">
                    Rapat
                    Kerja Gabungan Lembaga Mahasiswa</h5>
                <p class="mb-3 font-normal text-center text-white">bakti sosial adalah salah satu program kerja yang
                    dinaungi oleh
                    Komisi 5</p>
                    ...
                    <div class="origin-top-right rounded-md bg-white ring-1 shadow-lg ring-black/5 focus:outline-hidden overflow-hidden h-0 transition-all duration-300"
                        ...
                        <div class="overflow-y-auto max-h-[800px] [&::-webkit-scrollbar]:hidden sm:p-11 p-6">
                            ...
                            <p class="mt-5 text-slate-500 text-justify text-[12px] sm:text-[16px]">Lorem ipsum dolor sit
                                ...
                                rerum sequi. Est, illo. Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis
                                natus vero voluptatum
                                aspernatur sit in repellendus blanditiis consequatur! Accusantium reiciendis numquam
                                excepturi voluptatibus earum
                                recusandae exercitationem dolore in modi? Ducimus? Lorem ipsum, dolor sit amet
                                consectetur adipisicing elit.
                                Aperiam laboriosam, ipsa facilis corrupti molestias est at dolores illo, in
                                reprehenderit natus cupiditate
                                quisquam aliquid asperiores ratione dolor quo et fugiat! Lorem ipsum dolor sit amet,
                            ...
                            <p class="mt-2 text-slate-500 text-justify text-[12px] sm:text-[16px]">
                                ...
                                pariatur sunt error a ab doloribus architecto laboriosam culpa impedit, quos porro, qui
                            ...
                            <p class="mt-2 text-slate-500 text-justify text-[12px] sm:text-[16px]"> Molestiae minima
                                ...
                                ipsum dolor sit amet, consectetur adipisicing elit. Delectus natus iure id nulla in
                                beatae quidem hic ipsam, odio
                                asperiores saepe doloremque tempora ex temporibus? Impedit saepe quisquam molestias
                                ratione. Lorem ipsum dolor
                                sit amet consectetur adipisicing elit. Possimus, illum consequuntur! Ducimus sed, sint,
                                veniam amet voluptate
                                quam nihil molestias dolores velit minima perferendis iusto expedita quaerat nostrum
                                fuga quod? Lorem ipsum dolor
                                sit amet consectetur adipisicing elit. Assumenda officia impedit rem fugit? Magnam, sunt
                                eaque iure culpa
