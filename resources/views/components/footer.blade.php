<footer id="footer" class="footer lg:px-24 px-12 pt-6 pb-4 md:py-4 w-full">
    <div class="flex md:flex-row flex-col gap-4 justify-between items-start md:mt-2">
        <div class="flex flex-col gap-2 mt-1 xl:scale-100 scale-90">
            ...
            <div class="flex gap-3 items-center">
                ...
                <h1 class="text-base text-slate-800">+62-838-5102-8574</h1>
            </div>
            <div class="flex gap-3 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
        ...
        <div class="flex flex-row xl:gap-24 md:px-0 px-2 gap-12 xl:scale-100 scale-90">
            <div class="md:flex flex-col gap-2 hidden">
                ...
                <a href="/program-kerja" class="text-base text-slate-800 hover:text-blue-800">Program Kerja</a>
            ...
            <div class="flex flex-col gap-2 mt-4 md:mt-0">
                ...
                <div class="flex md:flex-col flex-row md:gap-2 gap-4">
                    <a href="https://www.instagram.com/dpmfmipaunud?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="text-base text-slate-800 hover:text-blue-800 hover:fill-blue-800 fill-slate-800 flex gap-2 items-center">
                        ...
                        <span class="hidden md:flex">dpmfmipaunud</span>
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=100078741620037" class="text-base text-slate-800 hover:text-blue-800 hover:fill-blue-800 fill-slate-800 flex gap-2 items-center">
                        ...
                        <span class="hidden md:flex">Dpm Fmipa Udayana</span>
                    </a>
                    <a href="https://line.me/R/ti/p/@876iqhut" class="text-base text-slate-800 hover:text-blue-800 hover:fill-blue-800 fill-slate-800 flex gap-2 items-center">
                        ...
                        <span class="hidden md:flex">DPM FMIPA UNUD</span>
                    </a>
    ...
    <div class="border-t border-slate-500 mt-6 scale-100">
