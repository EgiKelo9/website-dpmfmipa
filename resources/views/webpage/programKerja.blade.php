<x-layouts.user>
    ...
    <div class="font-[Poppins]">
        ...
        <div class="relative font-poppins min-h-[450px] sm:min-h-[500px] lg:min-h-[600px]">
            <div
                ...
                <div
                    class="container mx-auto content-center flex md:flex-row flex-col items-center justify-center gap-6 lg:gap-12 px-12 min-h-[70vh]">
    ...
    <script src="js/animation/programkerja.js" ></script>
</x-layouts.user>
