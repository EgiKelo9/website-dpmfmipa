<x-layouts.user>
    ...
    <div class="font-[Poppins]">
            ...
            <div class="absolute top-0 left-0 w-full min-h-screen">
                <div class="flex md:flex-row flex-col items-center justify-center gap-6 lg:gap-12 px-12 min-h-screen">
                    ...
                    <div class="flex flex-col gap-2 md:gap-3 xl:gap-4">
                        <h1 class="text-wrap text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-center md:text-left font-bold text-white">DEWAN PERWAKILAN MAHASISWA</h1>
                        <h1 class="text-wrap text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-center md:text-left font-bold text-white">FAKULTAS MATEMATIKA DAN<br>ILMU PENGETAHUAN ALAM</h1>
                        <h1 class="text-wrap text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-center md:text-left font-bold text-white">UNIVERSITAS UDAYANA</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto content-center px-8 sm:px-12 lg:px-24">
        ...
        <div class="container mx-auto content-center px-8 sm:px-12 lg:px-24">
            <div class="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 w-full gap-8">
                <div class="bg-zinc-50 shadow-lg rounded-lg p-6 text-center hover:scale-105 transition-transform duration-300">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 lg:gap-8 mt-10">
                <div class="relative col-span-1 hover:scale-[102.5%] transition-transform duration-300">
                    ...
                    <div class="absolute right-0 left-0 bottom-4 xl:bottom-6">
                        <h1 class="text-lg sm:text-base md:text-lg lg:text-xl font-semibold text-white truncate mx-4 xl:mx-6">Rapat Kerja gabungan LM FMIPA 2025</h1>
                        <h1 class="text-base sm:text-sm md:text-base text-white font-light truncate mt-0.5 lg:mt-1 mx-4 xl:mx-6">Selengkapnya ></h1>
                    </div>
                </div>
                <div class="relative col-span-1 hover:scale-[102.5%] transition-transform duration-300">
                    <img src="{{ asset('images/vikasasamyukta.jpg') }}" class="w-full object-cover">
                    <div class="absolute right-0 top-0 left-0 bottom-0 bg-gradient-to-t from-sky-950 to-transparent"></div>
                    <div class="absolute right-0 left-0 bottom-4 xl:bottom-6">
                        <h1 class="text-lg sm:text-base md:text-lg lg:text-xl font-semibold text-white truncate mx-4 xl:mx-6">Sidang Pleno DPM FMIPA 2025</h1>
                        <h1 class="text-base sm:text-sm md:text-base text-white font-light truncate mt-0.5 lg:mt-1 mx-4 xl:mx-6">Selengkapnya ></h1>
                    </div>
                </div>
                <div class="relative col-span-1 hover:scale-[102.5%] transition-transform duration-300">
                    ...
                    <div class="absolute right-0 top-0 left-0 bottom-0 bg-gradient-to-t from-sky-950 to-transparent"></div>
                    <div class="absolute right-0 left-0 bottom-4 xl:bottom-6">
                        <h1 class="text-lg sm:text-base md:text-lg lg:text-xl font-semibold text-white truncate mx-4 xl:mx-6">Upgrading DPM FMIPA 2025</h1>
                        <h1 class="text-base sm:text-sm md:text-base text-white font-light truncate mt-0.5 lg:mt-1 mx-4 xl:mx-6">Selengkapnya ></h1>
                    </div>
                </div>
            </div>
        ...
        <div class="my-20">
            <div class="pt-40 pb-32 relative">
                ...
                <div class="items-center text-center justify-center">
                    <h1 class="text-white text-2xl md:text-4xl font-bold text-center relative">SAMPAIKAN ASPIRASIMU!</h1>
                    <a href="/aspirasi" class="text-white text-base sm:text-xl text-center relative">Lihat lebih lengkap ></a>
                </div>
            </div>
        </div>
    </div>
